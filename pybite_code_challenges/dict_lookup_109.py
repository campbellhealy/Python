...
def get_workout_motd(day):
    """First title case the passed in day argument
       (so monday or MONDAY both result in Monday).
            # lower and title the days of the week

       If day is not in WORKOUT_SCHEDULE, return INVALID_DAY
            # nonesense days are invalid days
    ...
    while day in WORKOUT_SCHEDULE:
        ...
        elif day in WORKOUT_SCHEDULE:
            TRAIN = f'Go train {WORKOUT_SCHEDULE[day]}'
            return (TRAIN)
